  ...
  navlistPanel(
    tabPanel("Methods",
             mainPanel(
              ...
              p("This app calculates salinity from conductivity data using the PSS-78 practical salinity equation. In its current form yemperature and hydrostatic pressure are assumed to be 25 deg C and 0 dBar respectively."),
